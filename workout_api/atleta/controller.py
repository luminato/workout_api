...
async def post(
    ...
    try:
        ...
        error_message = str(e)
        cpf = error_message.split("cpf=")[-1].split(")")[0]
        raise HTTPException(
...
async def query(
    ...
    paginated_atletas = paginate(atletas, limit=limit, offset=offset)
...
async def query(
    ...
    # Construir objetos AtletaSummary ao invés de AtletaOut
    response_data = [
        {
            "nome": atleta.nome,
